...
def parse_args():
    ...
    # environment
    parser.add_argument("--scenario_name", type=str, default="multi_tag", help="name of the scenario script")
    ...
    parser.add_argument("--learning_start_step", type=int, default=50, help="learning start steps")
